...
<template>
    <AuthenticatedLayout>
        <Head title="Reports / Violation Summary" />
            ...
            <div class="mx-auto sm:px-6 lg:px-8">
                <div class="overflow-hidden bg-white shadow-lg sm:rounded-lg">
                    <div class="p-6 text-gray-900 flex flex-col md:flex-row md:justify-between md:items-center space-y-4 md:space-y-0 ">
                        <h3 class="text-2xl font-bold ">Reports - Violation Summary</h3>
                    ...
                    <table class="min-w-full border border-gray-200" ref="printTable">
                        <thead class="bg-gray-100">
                            <tr>
                                ...
                                <th class="px-4 py-2 text-left text-gray-700 border-b">Violation Code</th>
                                <th class="px-4 py-2 text-left text-gray-700 border-b">Violation Name</th>
                        ...
                        <tbody>
                            <tr class="border-b" v-for="(item, index) in data" :key="index">
                                ...
                                <td class="px-4 py-2">{{ item.violation_code }}</td>
                                <td class="px-4 py-2">{{ item.violation_name }}</td>
