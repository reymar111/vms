        ...
        <div class="py-1">
            <div class="mx-auto sm:px-6 lg:px-8">
                ...
                <div class="p-6 text-gray-900 flex flex-col md:flex-row md:justify-between md:items-center space-y-4 md:space-y-0 ">
                    <h3 class="text-2xl font-bold ">Settings - Semester</h3>
                ...
                <div class="px-6 pb-6 overflow-x-auto bg-white shadow-md rounded-lg mt-0">
                    ...
                    <table class="min-w-full border border-gray-200">
                        ...
                        <tbody>
                            <tr class="border-b" v-for="(item, index) in filteredSemesters" :key="index">
                ...
                <div class="relative bg-white rounded-lg shadow-sm ">
                    ...
                    <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t border-gray-200">
                        <h3 class="text-xl font-semibold text-gray-900 ">
                            {{ form.is_editing ? 'Edit' : 'Create' }} Semester
                        </h3>
...
export default {
    ...
    computed: {
        filteredSemesters() {
            if (!this.search) return this.semesters;

            return this.semesters.filter(semester => {
                return Object.values(semester).some(value =>
    ...
    methods: {
        ...
        update() {
            this.form.patch('/semester/update/'+this.form.id, {
                onSuccess: () => {
                    this.closeForm()
        ...
        deleteItem() {
            this.form.delete('/semester/destroy/'+this.delete_form.id, {
                onSuccess: () => {
