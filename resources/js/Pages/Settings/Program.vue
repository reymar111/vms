        ...
        <div class="py-1">
            <div class="mx-auto sm:px-6 lg:px-8">
                ...
                <div class="p-6 text-gray-900 flex flex-col md:flex-row md:justify-between md:items-center space-y-4 md:space-y-0 ">
                    <h3 class="text-2xl font-bold ">Settings - Programs</h3>
                    ...
                    <table class="min-w-full border border-gray-200">
                        <thead class="bg-gray-100">
                            <tr>
                                ...
                                <th class="px-4 py-2 text-left text-gray-700 border-b">Program</th>
                        ...
                        <tbody>
                            <tr class="border-b" v-for="(item, index) in filteredPrograms" :key="index">
                                <td class="px-4 py-2">{{ index + 1 }}</td>
                                <td class="px-4 py-2">{{ item.college ? item.college.code : '' }}</td>
                ...
                <div class="relative bg-white rounded-lg shadow-sm ">
                    ...
                    <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t border-gray-200">
                        <h3 class="text-xl font-semibold text-gray-900 ">
                            {{ form.is_editing ? 'Edit' : 'Create' }} Program
                        </h3>
                    ...
                    <div class="p-4 md:p-5 space-y-4">
                        <div>
                            ...
                            <select v-model="form.college_id" id="countries" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                <option v-for="(item, index) in colleges" :key="index" :value="item.id">{{ item.code }}</option>
                            </select>
                        </div>
...
export default {
    ...
    computed: {
        filteredPrograms() {
            if (!this.search) return this.programs;
    ...
    methods: {
        ...
        editItem(item) {
            ...
            this.form.college_id = item.college_id
        ...
        update() {
            this.form.patch('/program/update/'+this.form.id, {
                onSuccess: () => {
                    this.closeForm()
        ...
        deleteItem() {
            this.form.delete('/program/destroy/'+this.delete_form.id, {
                onSuccess: () => {
